...
public class CommunityModelTests {
    ...
    // Events and Projects if attached to the community, needs to be tested
    // separately
    @Test
    public void addCommunityTestWithoutProjectAndEvents() {
        ...
        // Doing the save using the service layer which in turn will use the mocked repo
        // layer
    ...
    public void testCaseToCheckGetCommunityById() {
        ...
        // create a Dummy Community Object
        Community dummyCommunity = new Community(1L, "Test Community", "Test community description",
                "communityImage.jpg");
    ...
    public void testGetAllCommunities() {
        ...
        Community dummyCommunity1 = new Community(1L, "Test Community", "Test community description",
                "communityImage.jpg");
        Community dummyCommunity2 = new Community(1L, "Test Community -2", "Test community description -2",
                "communityImage2.jpg");
        ...
        Set<Community> communitiesFromApi = communityService.getAllCommunities("hello");
